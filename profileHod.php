<?php
    ...
    if(isset($_POST['btnsubmit']))
    {
        ...
        $dept=$_POST['Departmentdropdown'];
        $jyear=$_POST['txtjyear'];*/

        $update="UPDATE tblregister set Fname='".$_POST['txtfname']."',Lname='".$_POST['txtlname']."',Phone='".$_POST['txtphone']."',PrnEmpno='".$_POST['txtempno']."',Deptid='".$_POST['Departmentdropdown']."',JoinYear='".$_POST['txtjyear']."' WHERE Uid='".$_SESSION['UserID']."'";
    ...
    <!-- javascript validation start  -->
        <script type="text/javascript">
            function validate()
            {
                ...
                var empno = document.forms["myform"]["txtempno"].value;
                ...
                if(empno == ""){
                    document.getElementById('empnospan').innerHTML =" ** Please enter employee number";
                    return false;
                }else{
                            ...
                            <div class="create-information">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Emp No:</label>
                                                <input type="text" name="txtempno" value="<?php echo $prnrmpno; ?>" class="form-control" placeholder="104289">
                                                <span id="empnospan" style="color: red"></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="txtjyear" value="<?php echo $jyear; ?>" class="form-control" placeholder="2018">
